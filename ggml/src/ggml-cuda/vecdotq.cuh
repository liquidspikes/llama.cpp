...
// VDR=4: two adjacent 16-element chunks (32 elements). Both share the q8_1
// block pair, sub-scales, mins and d8, so loads amortize over 2x dp4a work.
...
// VDR=4: two adjacent 16-element chunks (32 elements).
...
// VDR=2: two adjacent 8-element chunks (16 elements).
...
#pragma unroll
    for (int i = 0; i < 2*QR6_K; ++i) {
        ...
        sumf += d8[i&1] * (ggml_cuda_dp4a(vi, u[i], 0) * sc);
    }
...
// VDR=4 entry: iqs is a multiple of 4. Processes 32 elements per call.
...
// VDR=2 entry: iqs is even. Processes 16 elements per call.
